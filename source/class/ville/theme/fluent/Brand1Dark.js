 ...
 */
qx.Theme.define("ville.theme.fluent.Brand1Dark",
{  
  ...
  colors :
  {
    ...
    "table-row-background-focused-selected" : ville.global.color.Brand[30], //BrandBackground2
    "table-row-background-focused" : ville.global.color.Brand[30], //BrandBackground2
    "table-row-background-selected" : ville.global.color.Brand[30], //BrandBackground2
